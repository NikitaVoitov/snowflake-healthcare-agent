...
"""
.. envvar:: OTEL_SNOWFLAKE_CORTEX_ANALYST_CREDITS_PER_MESSAGE

Credits consumed per Cortex Analyst message (successful HTTP 200 responses only).
Default: ``0.067`` credits/message (6.7 credits per 100 messages).

**Important:** Token count does NOT affect cost for direct Cortex Analyst calls.
...
"""
.. envvar:: OTEL_SNOWFLAKE_CORTEX_SEARCH_CREDITS_PER_1000_QUERIES

Credits consumed per 1000 Cortex Search queries. Default: ``1.7`` credits/1000 queries.

Reference: https://www.snowflake.com/legal-files/CreditConsumptionTable.pdf
"""

OTEL_SNOWFLAKE_CREDIT_PRICE_USD = "OTEL_SNOWFLAKE_CREDIT_PRICE_USD"
"""
.. envvar:: OTEL_SNOWFLAKE_CREDIT_PRICE_USD

Price per Snowflake credit in USD. Default: ``3.00`` (On-Demand pricing).
Actual price varies by contract, cloud provider, and region.
Set to your contracted rate for accurate cost estimation.
"""
